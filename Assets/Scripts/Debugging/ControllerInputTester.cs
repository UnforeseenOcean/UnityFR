...
public class ControllerInputTester : MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetAxis("Horizontal") > 0){
			Debug.Log("HORIZONTAL POS: " + Input.GetAxis("Horizontal"));
		}
		else if(Input.GetAxis("Horizontal") < 0){
			Debug.Log("HORIZONTAL NEG: " + Input.GetAxis("Horizontal"));
		}

		if(Input.GetAxis("Vertical") > 0){
			Debug.Log("VERTICAL POS: " + Input.GetAxis("Vertical"));
		}
		else if(Input.GetAxis("Vertical") < 0){
			Debug.Log("VERTICAL NEG: " + Input.GetAxis("Vertical"));
		}

		//3rd axis
/*		if(Input.GetAxis("HorizontalLeftJoystick") > 0){
			Debug.Log("HORIZONTAL POS");
		}
		else if(Input.GetAxis("HorizontalLeftJoystick") < 0){
			Debug.Log("HORIZONTAL NEG");
		}
