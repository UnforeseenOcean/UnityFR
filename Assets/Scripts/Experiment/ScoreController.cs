...
public class ScoreController : MonoBehaviour {
	...
	static int objectPoints = 50;
	public static int ObjectPoints { get { return objectPoints; } }
	...
	public int AddObjectPoints (){
		int objPoints = 0;
		if (isCorrect()) {
			objPoints = objectPoints;
		}
		else{ //wrong
			objPoints = memoryScoreWrong;
		}
		
		AddToScore(objPoints);
		scoreLogger.LogObjectScoreAdded (objPoints);
